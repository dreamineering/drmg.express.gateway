...
module.exports = function(req, res, next) {
  // Generate XSRF token
  //var token = req.session._csrf || (req.session._csrf = uid(24)); // not using sessions so is this needed?
  // could save the key onto the user profile on login and destroy on signout
